...
func opCreate(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	...
	// if interpreter.evm.chainRules.IsEIP150 {	// TODO: interpreter.evm.chainRules.IsEIP150 = true
	gas -= gas / 64
	// }
	...
	if suberr == ErrCodeStoreOutOfGas { // TODO: remove "interpreter.evm.chainRules.IsHomestead"
		stackvalue.Clear()
